                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  class="form-control" name="item_type" id="item_type">
                                                @foreach($itemtype as $k=>$data)
                                                    <option value="{{$k}}" {{ old('item_type')==$k?"selected":""}}> {{ $data}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  class="form-control" name="buyer_id" id="buyer_id">
                                                ...
                                                @forelse($buyers as $data)
                                                    <option value="{{$data->id}}" {{ old('buyer_id')==$data->id?"selected":""}}> {{ $data->name}} - {{ $data->contact}}</option>
                                                @empty
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="size" value="{{old('size')}}" class="form-control" placeholder="Size" name="size">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
