@extends('layout.app')
@section('pageTitle','Semi Finish Product List')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="row pb-1">
                        ...
                        <div class="col-2"><a class="btn btn-sm btn-primary float-end" href="{{route(currentUser().'.semifinishproduct.create')}}"><i class="bi bi-plus-square"></i> Add New</a></div>
                    </div>
                    <!-- table bordered -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="white-space-nowrap">
                                        <a href="{{route(currentUser().'.semifinishproduct.edit',encryptor('encrypt',$data->id))}}">
