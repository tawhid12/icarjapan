@extends('layout.app')
@section('pageTitle','Edit Semi Finish Product')
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-content">
                      <div class="card-body">
                          <form class="form" method="post" action="{{route(currentUser().'.semifinishproduct.update',encryptor('encrypt',$product->id))}}">
                                @csrf
                                @method('patch')
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="color" value="{{old('color',$product->color)}}" class="form-control" placeholder="Product Color" name="color">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="description">Description</label>
                                            <textarea id="description" class="form-control" placeholder="Description" name="description">{{old('description',$product->description)}}</textarea>
                                        </div>
                                    </div>
                                    {{--<div class="col-md-4 col-12">
                                        <div class="form-group">
