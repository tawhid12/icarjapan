...
<div class="left-row left-row-7 mb-3">
  <div class="card shadow radious-10">
    ...
    <div class="card-body">
      ...
      <p class="card-text">
        <a href="{{url('/')}}/vehicle/advance/search/data?body_type={{$bt->id}}" style="text-decoration:none;color:#000;"><i class="bi bi-car-front-fill"></i>{{$bt->name}} ({{$bt->vehicles_count}})</a>
      </p>
      @endif
      @empty
      @endforelse
