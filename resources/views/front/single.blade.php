        ...
        <div class="container">
            <div class="row gx-3">
                ...
                <div class="row">
                                        ...
                                        @forelse($recomended as $r)
                                            <div class="col-12">
                                                <div class="product-card my-3">
                                                    @php
                                                        $cover_img = \DB::table('vehicle_images')
                                                            ->where('vehicle_id', $r->vid)
                                                            ->where('is_cover_img', 1)
                                                            ->first();
                                                    @endphp
                                                    @if ($cover_img)
                                                        <img class="img-fluid"
                                                    ...
                                                    <div class="product-card-body">
                                                        <p clss="m-0"><a
                                                                href="{{ route('singleVehicle', ['brand' => $r->b_slug, 'subBrand' => $r->sb_slug, 'stock_id' => $r->stock_id]) }}"
                                                                style="text-decoration:none!important;">{{ str_replace('-', ' ', $r->name) }}</a>
                                                        </p>
                                                        ...
                                                        @if ($price > 0)
                                                            ...
                                                            <div class="product-card-currency">
                                                                <p>Approx.</p>
                                                                <p>{{ $location['geoplugin_currencyCode'] }}
                                                                    {{ number_format($location['geoplugin_currencyConverter'] * $price, 2, ',', ',') }}
                                                                </p>
                                                            </div>
                                                        @else
                                                            <p>Ask</p>
                    ...
                    <div class="col-sm-10 col-md-10 col-lg-10 container-xl-9">
                        <!-- mid row 1 -->
                                    ...
                                    <div class="hg-box inv">
                                        <p>
                                            <span>
                                                @if ($v->inv_loc)
                                                    @if ($v->inv_loc->image)
                                                        <img src="{{ asset('uploads/country/' . $v->inv_loc->image) }}"
                                                            alt="" />
                                                    @endif
                                                @endif
                                            </span>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="contents_detail" class="single">
                                            <div class="car_display_area">
                                                <div id="car_MainIMG_car_display">
                                                    @forelse($v_images as $v_img)
                                                        <div>
                                                            ...
                                                            <img src="{{ asset('uploads/vehicle_images/' . $v_img->image) }}"
                                                                alt="" width="592" height="480" />
                                                        </div>
                                                    @empty
                                                    @endforelse
                                                ...
                                                <p id="pager_display" class="nopointer_event nowrap_txt"><span
                                                        ...
                                                        id="totalPages_display">00</span></p>
                                            </div>
                                            <div>
                                            ...
                                            <div id="car_thumbnail_car_navigation"
                                                class="clearfix car_detail_car_navigation">
                                                @forelse($v_images as $key => $v_img)
                                                    @if ($key == 0)
                                                        <div id="imgdisp_select{{ $key }}" class="now_imgDisplay">
                                                            <!--<img class="lazy" src="{{ url('public/uploads/default/comingsoon_l.png') }}" data-original="" alt="" />-->
                                                            <img src="{{ route('resizeImage', ['vehicle_images', $v_img->image, 75, 75]) }}"
                                                                alt="" />
                                                        </div>
                                                    @else
                                            ...
                                            <table class="table table-sm detl">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ optional($v->inv_loc)->name }} |
                                                            {{ optional($v->inv_port)->name }}</td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        @if ($v->option)
                                            ...
                                            <div class="bg-light shadow my-4">
                                                <table
                                                    class="table table-hover table-sm table-bordered boder border-danger-subtle">
                                                    <thead>
                                                        <tr class="table-dark">
                                                            <th class="text-center" colspan="4" scope="col">
                                                                Options
                                        ...
                                        <div class="mt-2">
                                            <table
                                                class="m-0 table table-hover table-sm table-bordered boder border-danger-subtle">
                                                <thead>
                                                    <tr class="table-dark">
                                                        <th class="text-center" colspan="4" scope="col">
                                                            Features
                                            ...
                                            <div class="row gx-0">
                                                ...
                                                @if ($v->cd_player == 1)
                                                    <div class="col-md-3 bg-danger-subtle">CD Player</div>
                                                @endif
                                                @if ($v->sun_roof == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Sun Roof</div>
                                                @endif
                                                @if ($v->leather_seat == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Leather Seat</div>
                                                @endif
                                                @if ($v->alloy_wheels == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Alloy Wheels</div>
                                                @endif

                                                @if ($v->power_steering == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Power Steering</div>
                                                @endif
                                                @if ($v->power_windows == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Power Windows</div>
                                                @endif
                                                @if ($v->air_con == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Air Con</div>
                                                @endif
                                                @if ($v->anti_lock_brake_system == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Anti lock Brake System</div>
                                                @endif

                                                @if ($v->air_bag == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Air Bag</div>
                                                @endif
                                                @if ($v->radio == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Radio</div>
                                                @endif
                                                @if ($v->cd_changer == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Cd Changer</div>
                                                @endif
                                                @if ($v->dvd == 1)
                                                    <div class="col-md-3 bg-danger-subtle">DVD</div>
                                                @endif

                                                @if ($v->tv == 1)
                                                    <div class="col-md-3 bg-danger-subtle">TV</div>
                                                @endif
                                                @if ($v->power_seat == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Power Seat</div>
                                                @endif
                                                @if ($v->back_tire == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Back Tire </div>
                                                @endif
                                                @if ($v->grill_guard == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Grill Guard</div>
                                                @endif

                                                @if ($v->rear_spoiler == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Rear Spoiler</div>
                                                @endif
                                                @if ($v->central_locking == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Central Locking</div>
                                                @endif
                                                @if ($v->jack == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Jack</div>
                                                @endif
                                                @if ($v->spare_tire == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Spare Tire</div>
                                                @endif

                                                @if ($v->wheel_spanner == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Wheel Spanner</div>
                                                @endif
                                                @if ($v->fog_lights == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Fog Lights</div>
                                                @endif
                                                @if ($v->back_camera == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Back Camera</div>
                                                @endif
                                                @if ($v->push_start == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Push Start</div>
                                                @endif

                                                @if ($v->keyless_entry == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Keyless Entry</div>
                                                @endif
                                                @if ($v->esc == 1)
                                                    <div class="col-md-3 bg-danger-subtle">ESC</div>
                                                @endif
                                                @if ($v->deg_360_cam == 1)
                                                    <div class="col-md-3 bg-danger-subtle">360 Degree Camera</div>
                                                @endif
                                                @if ($v->body_kit == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Body Kit</div>
                                                @endif

                                                @if ($v->side_airbag == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Side Airbag</div>
                                                @endif
                                                @if ($v->power_mirror == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Power Mirror</div>
                                                @endif
                                                @if ($v->side_skirts == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Side Skirts</div>
                                                @endif
                                                @if ($v->front_lip_spoiler == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Front Lip Spoiler</div>
                                                @endif

                                                @if ($v->navigation == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Navigation</div>
                                                @endif
                                                @if ($v->turbo == 1)
                                                    <div class="col-md-3 bg-danger-subtle">Turbo</div>
                                                @endif
                                            </div>
                                        </div>
                                        @php
                                    ...
                                    <div class="col-sm-4">
                                                    ...
                                                    <table class="table table-bordered m-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @if ($price_after_dis > 0)
                                                                <tr>
                                                                    <th scope="row" class="fs-6">Vehicle Price
                                                                    </th>
                                                            ...
                                                            @if ($dis_price > 0)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>USD {{ $dis_price }} ({{ $v->discount }}%)
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                            @if ($price_after_dis > 0)
                                                                <input type="hidden" class="convert_price"
                                                                    value="{{ round($location['geoplugin_currencyConverter'] * $price_after_dis) }}">
                                                            @endif
                                                            <tr>
                                                                        ...
                                                                        @if (count($countries) > 0)
                                                                            @forelse($countries as $c)
                                                                                @if (\Session::get('country_id') && empty(request('country_id')))
                                                                                    <option value="{{ $c->id }}"
                                                                                        @if (\Session::get('country_id') == $c->id) selected @endif>
                                                                                        {{ $c->name }}</option>
                                                                                ...
                                                                                @else
                                                                                    <option value="{{ $c->id }}"
                                                                                        @if ($countryName->id == $c->id) selected @endif>
                                                                                        {{ $c->name }}</option>
                                                                                @endif
                                                                ...
                                                                <td>
                                                                    @php
                                                                        if (
                                                                            ...
                                                                            $des_port = \DB::table('ports')
                                                                                ->where(
                                                                                    'inv_loc_id',
                                                                                    \Session::get('country_id'),
                                                                                )
                                                                                ->get();
                                                                            $des_country = \DB::table('countries')
                                                                                ->where(
                                                                                    'id',
                                                                                    \Session::get('country_id'),
                                                                                )
                                                                            ...
                                                                            $des_port = \DB::table('ports')
                                                                                ->where('inv_loc_id', $countryName->id)
                                                                                ->get();
                                                                            $des_country = \DB::table('countries')
                                                                                ->where('id', $countryName->id)
                                                                                ->first();
                                                                        }

                                                                    @endphp
                                                                    <select class="des_port form-select form-select-sm"
                                                                        aria-label=".form-select-sm example">
                                                            ...
                                                            <tr>
                                                                <th scope="row">Inspection<input type="checkbox"
                                                                        class="mx-2 chk"
                                                                        value="{{ $des_country->inspection }}"></th>
                                                                <td class="ins_txt">USD {{ $des_country->inspection }}
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <th scope="row">Insurance<input type="checkbox"
                                                                        class="mx-2 chk"
                                                                        value="{{ $des_country->insurance }}"></th>
                                                                <td class="insu_txt">USD {{ $des_country->insurance }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row"></th>
                                                            ...
                                                            <tr>
                                                                <th colspan="2" scope="row">
                                                                    ...
                                                                    ICARJAPAN shall not be responsible for any loss,
                                                                    damages
                                                            ...
                                                            <tr class="table-dark">
                                                                ...
                                                                <td class="fw-bold h-t-price" style="font-size:large">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="card shadow radious-10 my-3 contact-us-section">
                                            ...
                                            @if ($v->r_status)
                                                <div class="p-2 customer-highlights text-center">
                                                    <form id="notify-active-form" method="POST"
                                                        ...
                                                        @if (currentUserId())
                                                            <a href="javascript:void(0)" data-name="{{ $v->fullName }}"
                                                                class="notify mr-2 bg-button" data-toggle="tooltip"
                                                                title="Notify Me"><i
                                                                    class="bi bi-cart-check-fill"></i>Notify Me</a>
                                                        @else
                                                            <a class="bg-button" href="#" data-bs-toggle="modal"
                                                                data-bs-target="#buy_now"><i
                                                                    class="bi bi-cart-check-fill"></i> Notify Me</a>
                                                        @endif
                                                    </form>
                                                </div>
                                            @else
                                                <div class="p-2 customer-highlights text-center">
                                                    <a class="bg-button" href="#" data-bs-toggle="modal"
                                                        data-bs-target="#inquiry"><i class="bi bi-envelope-at-fill"></i>
                                                        inquiry
                                                    </a>
                                                    <p class="">OR</p>
                                                    <form id="active-form" method="POST"
                                                        action="{{ route('user.reservevehicle.store') }}"
                                                        style="display: inline;">
                                                        @csrf
                                                        <input name="vehicle_id" type="hidden"
                                                            value="{{ $v->id }}">
                                                        ...
                                                        @if (currentUserId())
                                                            <a href="javascript:void(0)" data-name="{{ $v->fullName }}"
                                                                class="confirm mr-2 bg-button" data-toggle="tooltip"
                                                                title="Reserve now"><i class="bi bi-cart-check-fill"></i>
                                                                Reserve Now</a>
                                                        @else
                                                            <a class="bg-button" href="#" data-bs-toggle="modal"
                                                                data-bs-target="#buy_now"><i
                                                                    class="bi bi-cart-check-fill"></i> Reserve Now</a>
                                                        @endif
                                                    </form>
                                                    <div class="my-3">
                                        ...
                                        <div class="modal fade" id="inquiry" tabindex="-1"
                                            aria-labelledby="my-modal-label" aria-hidden="true">
                                                        ...
                                                        <div class="row">
                                                            @if (count($v_images) > 0)
                                                                <div class="col-md-2">
                                                                    <img style="max-width:80px;"
                                                                        ...
                                                                        src="{{ asset('uploads/vehicle_images/' . $v_images->first()->image) }}"
                                                                        alt="" />
                                                                </div>
                                                            @endif
                                                            <div class="col-md-10">
                                                            ...
                                                            <form class="form" method="post"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <small class="text-danger">Please click "Inquiry"
                                                                        to receive your quote from us. You need to
                                                                        provide us with your contact details to receive
                                                                        a free quote.</small>
                                        ...
                                        <!-- Buy Now Form -->
                                        <div class="modal fade" id="buy_now" tabindex="-1"
                                            aria-labelledby="my-modal-label" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <p class="m-0 text-center">
                                                            ...
                                                            Please sign up if you don't have an account yet.(Create
                                                            Account >>)
                                                        </p>
                                                        <div class="d-flex justify-content-center mt-2">

                                                            <a href="{{ route('login') }}"
                                                                class="btn btn-primary me-2">Login</a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="reviewModalLabel">Write a Review
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="reviewForm" enctype="multipart/form-data">
                                                            @csrf
                                                            <input type="hidden" name="review_type" id="review-type"
                                                                value="3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reviewModal').on('show.bs.modal', function(event) {
                ...
                var vehicle_id = button.data('vehicle-id'); // Extract info from data-* attributes
                var modal = $(this);
            ...
            $(function() {
                    ...
                    $("#car_MainIMG_car_display").on("init", function(e, t) {
                        $("#currentPage_display").text(t.currentSlide + 1), $("#totalPages_display")
                            .text(t.slideCount)
                    }).slick({
                        adaptiveHeight: !0,
                        edgeFriction: .2,
                        ...
                        ($("#currentPage_display").text(r + 1), $(
                            '#car_thumbnail_car_navigation div[id^="imgdisp_select"]').removeClass(
                            "now_imgDisplay"), $("div#imgdisp_select" + r).addClass(
                            "now_imgDisplay"), $(".slick-current").hasClass("ytonly")) ? ($(
                                "#car_MainIMG_car_display .ytslide.slick-current > iframe")[0]
                            .contentWindow.postMessage(
                                '{"event":"command","func":"playVideo","args":""}', "*"), $(
                                "#car_MainIMG_car_display, #car_MainIMG_car_display .ytslide.slick-current > iframe"
                            ).addClass("playingYoutube")) : $(
                            "#car_MainIMG_car_display .ytslide > iframe").hasClass(
                            "playingYoutube") && ($("#car_MainIMG_car_display .ytslide > iframe")[0]
                            .contentWindow.postMessage(
                                '{"event":"command","func":"pauseVideo","args":""}', "*"), $(
                                "#car_MainIMG_car_display, #car_MainIMG_car_display .ytslide > iframe"
                            ).removeClass("playingYoutube")), $(".slick-current").hasClass(
                            "vronly") ? $("#car_MainIMG_car_display").addClass("playingVR") : $(
                            "#car_MainIMG_car_display").removeClass("playingVR")
                    })
                }), $(function() {
                    "use strict";
                    $("#car_thumbnail_car_navigation").slick({
                        ...
                        focusOnSelect: !0,
                        zIndex: 100
                    }), $('#car_thumbnail_car_navigation div[id^="imgdisp_select"]').on("click",
                        function() {
                            var e = $(this).attr("id").replace("imgdisp_select", "");
                            $('#car_thumbnail_car_navigation div[id^="imgdisp_select"]').removeClass(
                                "now_imgDisplay"), $(this).addClass("now_imgDisplay"), $(
                                "#car_MainIMG_car_display").slick("slickSetOption", "lazyLoad",
                                "ondemand", !0).slick("slickGoTo", e)
                        })
                }), $(function() {
                    "use strict";
            ...
            function container() {
                ...
                $('.insu_txt').text('Ask');
                if (convert_price > 0) {
                    $('.total').text('Approx.  ' + "{{ $location['geoplugin_currencyCode'] }} " + (
                        convert_price));
                } else {
                    $('.total').text('Ask');
                }
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            if (res) {
                                ...
                                $('.total').text('Approx.  ' +
                                    "{{ $location['geoplugin_currencyCode'] }} " + (Math.round((
                                        charge * value * currency_rate) + convert_price + (
                                        ad_cost * currency_rate))));
                                $('.con_total').val((Math.round((charge * value * currency_rate) +
                                    convert_price + (ad_cost * currency_rate))));
                                ...
                                if ((Math.round((charge * value) + v_price + ad_cost)) > 0) {
                                    $('.h-t-price').text('USD ' + (Math.round((charge * value) +
                                        v_price + ad_cost)));
                                } else {
                                    $('.h-t-price').text('Ask');
                                }
                                $('.non_con_total').val((Math.round((charge * value) + v_price +
                                    ad_cost)));
                            } else {
                                $('.fr_val').val(0);
                                $('.fr_txt').text('USD 0');
                                $('.total').text('Approx.  ' +
                                    "{{ $location['geoplugin_currencyCode'] }} " + convert_price +
                                    arseFloat(ad_cost * currency_rate));
                                $('.con_total').val(convert_price + parseFloat(ad_cost *
                                    currency_rate));
            ...
            $('.chk').on('change', function() {
                ...
                var non_con_sum = parseFloat($('.non_con_total').val()) ? parseFloat($('.non_con_total')
                    .val()) : 0;
