...
@section('pageTitle','Add Shipping Details')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.shipment.store')}}">
                            @csrf
                            <input type="hidden" name="vehicle_id" value="{{$resrv->vid}}">
                            <input type="hidden" name="reserve_id" value="{{$resrv->id}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tracking_no" class="form-control" placeholder="Tracking Number" name="tracking_no" value="{{old('tracking_no')}}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="consignee_id" class="form-control">
                                            ...
                                            <option value="{{ $c->id}}">{{$c->c_name}}-{{$c->n_name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="dep_port_id" class="form-control">
                                            ...
                                            <option value="{{ $p->id}}">{{$p->name}}-{{$port_country->name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="ship_name" class="form-control" placeholder="Ship Name" name="ship_name" value="{{old('ship_name')}}">
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        <label for="voyage_no">Voyage No</label>
                                        <input type="text" id="voyage_no" class="form-control" placeholder="Voyage No" name="voyage_no" value="{{old('voyage_no')}}">
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
