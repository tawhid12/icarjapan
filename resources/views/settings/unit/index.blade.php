        ...
        <div class="row" id="table-bordered">
            <div class="col-12">
                <div class="card">
                    <!-- table bordered -->
                    <div>
                        <a class="btn btn-sm btn-primary float-end" href="{{route(currentUser().'.unit.create')}}"><i class="bi bi-plus-square"></i> Add New</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="white-space-nowrap">
                                        ...
                                        <form id="form{{$data->id}}" action="{{route(currentUser().'.unit.destroy',encryptor('encrypt',$data->id))}}" method="post">
                                            @csrf
                                            @method('delete')
                                        </form>--}}
                                    </td>
