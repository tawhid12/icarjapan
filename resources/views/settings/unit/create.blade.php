                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="unit_style_id" class="form-control" name="unit_style_id">
                                                ...
                                                @forelse($unitstyles as $us)
                                                    <option {{old('unit_style_id')==$us->id?"selected":""}} value="{{$us->id}}">{{$us->name}}</option>
                                                @empty
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" value="{{old('name')}}" class="form-control" placeholder="Unit Name" name="name">
                                        </div>
                                        @if($errors->has('name'))
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="qty" value="{{old('qty')}}" class="form-control" placeholder="0.00" name="qty">
                                        </div>
                                        @if($errors->has('qty'))
