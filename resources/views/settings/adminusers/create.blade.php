                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="company_id" class="form-control" name="company_id">
                                                ...
                                                @forelse($company as $data)
                                                    <option {{old('company_id')==$data->id?"selected":""}} value="{{$data->id}}">{{$data->name}}</option>
                                                @empty
                                    ...
                                    <div class="col-sm-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <select id="show_price" class="form-control" name="show_price">
                                                <option value="">Select Access</option>
                                                <option {{old('show_price')=="1"?"selected":""}} value="1">Active</option>
                                                <option {{old('show_price')=="2"?"selected":""}} value="2">Inactive</option>
                                            </select>
                                        </div>
