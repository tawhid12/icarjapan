@extends('layout.app')
@section('pageTitle','Create Buyer')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{route(currentUser().'.buyer.store')}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label for="buyer_code">Buyer Code <span class="text-danger">*</span></label>
                                            <input type="text" id="buyer_code" value="{{old('buyer_code')}}" class="form-control" placeholder="Buyer Code" name="buyer_code">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" value="{{old('name')}}" class="form-control" placeholder="Buyer Name" name="name">
                                        </div>
                                        @if($errors->has('name'))
