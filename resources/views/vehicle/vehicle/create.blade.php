                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="model_code" value="{{old('model_code')}}" class="form-control" placeholder="Vehicle Model Code" name="model_code">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="b_length" value="{{old('b_length')}}" class="form-control" placeholder="b_length" name="b_length">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="max_loading_capacity" value="{{old('max_loading_capacity')}}" class="form-control" placeholder="max_loading_capacity" name="max_loading_capacity">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="e_size" value="{{old('e_size')}}" class="form-control" placeholder="e_size" name="e_size">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="year" value="{{old('year')}}" class="form-control" placeholder="year" name="year">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="reg_year" value="{{old('reg_year')}}" class="form-control" placeholder="reg year" name="reg_year">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="manu_year" value="{{old('manu_year')}}" class="form-control" placeholder="manu_year" name="manu_year">
                                    </div>
                                </div>
