...
@if(!empty($purchased_vehicle))
<div class="border">
    <div class="p-2">
        <h5 class="text-center my-2 pb-2">Purchased History</h5>
        @forelse($purchased_vehicle as $v)
            ...
            <div class="row gx-2">
                <div class="col-md-6">
                    <div class="border p-2">
                        <div class="row gx-1">
                            <h6 class="border-bottom">{{ ++$loop->index }}.Purchase Details</h6>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p><i class="badge bg-success">Sold</i></p>
                                    @if(currentUser() == 'salesexecutive' && $payment == 0)
                                    <form id="approve-form" action="{{route(currentUser().'.reservecancel')}}" style="display: inline;">
                                        @csrf
                                        <input name="id" type="hidden" value="{{$v->id}}">
