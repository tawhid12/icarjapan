...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_stocks', function (Blueprint $table) {
            ...
            $table->string('pis_id',1500)->nullable();
            $table->string('pos_id',1500)->nullable();
            $table->string('pts_id',1500)->nullable();
            ...
            $table->integer('status')->default(0)->comment('0 in location, 1 in company, 2 in return, 3 out Production Line, 4 out other company/warehouse, 5 out Return, 6 out considerable, 7 out unusable,8 in trans , 9 out trans, ');
